const Inicio = () =>{
    ...
    document.body.style.backgroundImage='url(/Gameproject/images/background3_1.jpg)'
    introduccion()
}
...
const introduccion =()=>{
   switch (eleccion) {
        ...
        case 'guerrero':
            document.getElementById('showscreen').innerHTML=`<p id='beggining'>En las peligrosas tierras de Faerûn, existe un poderoso guerrero conocido como ${clase.nombre}, quien ha pasado gran parte de su vida en el campo de batalla. Con su coraje y habilidades en la lucha, ha ganado una gran reputación como uno de los guerreros más valientes y temidos del continente.
